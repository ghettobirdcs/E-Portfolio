  ...
  return (
    <header ref={ref}>
      ...
      >
        <h3>
          <a
            href="https://github.com/ghettobirdcs"
            target={"_blank"}
          ...
          <a
            href="https://www.linkedin.com/in/mckade-hinshaw-33440a35a"
            target={"_blank"}
            rel="noopener noreferrer"
          >
      ...
      >
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              Hello! I’m McKade, I tackle complex engineering challenges daily,
              alongside a team of elite software engineers. My mission is to
              continuously advance in web development, using my growing
              expertise to drive societal progress through technology.
            </ScrambleText>
          </p>
        </div>
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"McKade Hinshaw"} noblink />
        <br />
        <TextWriting
          controls={controls}
          delay={1.65}
