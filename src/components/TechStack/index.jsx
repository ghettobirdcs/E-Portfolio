        ...
        >
          <p className="theme--detail">
            <ScrambleText delay={1}>
              Explore the technologies that define my craft: HTML5, CSS3,
              JavaScript, TypeScript, React, and Firebase. Each tool is
              carefully selected to create seamless, modern web experiences.
            </ScrambleText>
          </p>
        </motion.div>
      </div>
