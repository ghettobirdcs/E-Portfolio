        ...
        >
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>
              Currently studying at FES Institute, I work on extremely difficult
              engineering problems every day while learning from a team
              consisting of some of the most talented and experienced software
              engineers. Continuously working towards improving my knowledge and
              skills to develop technologies that contribute to the betterment
              of society.
            </ScrambleText>
          </p>
        </motion.div>
        ...
        >
          <h1 draggable="false">
            <InteractiveMarquee wheelFactor={0} speed={1.3}>
              <span>ABOUT McKade Hinshaw</span>
              <span>ABOUT McKade Hinshaw</span>
              <span>ABOUT McKade Hinshaw</span>
              <span>ABOUT McKade Hinshaw</span>
              <span>ABOUT McKade Hinshaw</span>
