        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"McKade Hinshaw"} />
              </h2>
              <h4>
          ...
          <div className="resume--grid--experience--head">
            <p className="theme--detail">
              <ScrambleText delay={0}>
                A versatile software developer specializing in frontend
                development, with hands-on experience in advancted technologies.
                Driven by a passion for building scalable, efficient, and
                user-friendly applications and exuding strong determination to
